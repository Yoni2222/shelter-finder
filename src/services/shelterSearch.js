...
function findSheltersByAddress(query, allShelters) {
  const cityMap = {
    ...
    '\u05E0\u05EA\u05E0\u05D9\u05D4': '\u05E0\u05EA\u05E0\u05D9\u05D4', '\u05E4\u05EA\u05D7 \u05EA\u05E7\u05D5\u05D5\u05D4': '\u05E4\u05EA\u05D7 \u05EA\u05E7\u05D5\u05D5\u05D4', '\u05E8\u05D0\u05E9\u05D5\u05DF \u05DC\u05E6\u05D9\u05D5\u05DF': '\u05E8\u05D0\u05E9\u05D5\u05DF \u05DC\u05E6\u05D9\u05D5\u05DF', 'ראשון-לציון': 'ראשון לציון',
    ...
    'צפת': 'צפת',
    'טבריה': 'טבריה',
    'נס ציונה': 'נס ציונה', 'נס-ציונה': 'נס ציונה',
    'נוף הגליל': 'נוף הגליל', 'נוף-הגליל': 'נוף הגליל', 'נצרת עילית': 'נוף הגליל',
    'פרדס חנה': 'פרדס חנה-כרכור', 'פרדס חנה כרכור': 'פרדס חנה-כרכור', 'פרדס חנה-כרכור': 'פרדס חנה-כרכור',
    'יקנעם': 'יקנעם עילית', 'יקנעם עילית': 'יקנעם עילית',
    'זכרון יעקב': 'זכרון יעקב', 'זכרון': 'זכרון יעקב',
    'בנימינה': 'בנימינה-גבעת עדה', 'גבעת עדה': 'בנימינה-גבעת עדה', 'בנימינה-גבעת עדה': 'בנימינה-גבעת עדה', 'בנימינה גבעת עדה': 'בנימינה-גבעת עדה',
    'מגדל העמק': 'מגדל העמק', 'מגדל-העמק': 'מגדל העמק',
    'קריית מלאכי': 'קריית מלאכי', 'קרית מלאכי': 'קריית מלאכי',
    'טירת כרמל': 'טירת כרמל', 'טירת הכרמל': 'טירת כרמל', 'טירת-כרמל': 'טירת כרמל',
    'רמת ישי': 'רמת ישי', 'רמת-ישי': 'רמת ישי',
    'מעלות-תרשיחא': 'מעלות-תרשיחא', 'מעלות תרשיחא': 'מעלות-תרשיחא', 'מעלות': 'מעלות-תרשיחא', 'תרשיחא': 'מעלות-תרשיחא',
    'ערד': 'ערד',
    'אור עקיבא': 'אור עקיבא', 'אור-עקיבא': 'אור עקיבא',
    'אופקים': 'אופקים',
    'באר יעקב': 'באר יעקב', 'באר-יעקב': 'באר יעקב',
    'גבעת שמואל': 'גבעת שמואל', 'גבעת-שמואל': 'גבעת שמואל',
    'מעלה אדומים': 'מעלה אדומים', 'מעלה-אדומים': 'מעלה אדומים',
    'גני תקווה': 'גני תקווה', 'גני-תקווה': 'גני תקווה',
    'אריאל': 'אריאל',
    'כפר ורדים': 'כפר ורדים',
    'מטולה': 'מטולה',
    'קריית טבעון': 'קריית טבעון', 'קרית טבעון': 'קריית טבעון', 'טבעון': 'קריית טבעון', 'כפר-ורדים': 'כפר ורדים',
    'מצפה רמון': 'מצפה רמון', 'מצפה-רמון': 'מצפה רמון',
    'גדרה': 'גדרה',
    'ירוחם': 'ירוחם',
    ...
    'סביון': 'סביון',
    'שלומי': 'שלומי',
    'קריית עקרון': 'קריית עקרון', 'קרית עקרון': 'קריית עקרון',
    'קצרין': 'קצרין',
    'ראש פינה': 'ראש פינה', 'ראש-פינה': 'ראש פינה',
